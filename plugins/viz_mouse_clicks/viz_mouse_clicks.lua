...
function VizMouseClicks:loadImpl()
	...
	self._left_click_stroke_color = settings.colorFromHtml(cfg.left_click_stroke_color)
	self._right_click_stroke_color = settings.colorFromHtml(cfg.right_click_stroke_color)
